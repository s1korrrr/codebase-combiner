...
| Combined output and metadata | selected local files                         | Preview, copy, export, crash recovery | Local binary plist with legacy JSON read support; bounded to 72 MiB | None                                   | User can clear recovered output; file removed locally |
