...
| Node lint/format/tests/package        | PASS           | ESLint, Prettier, 8 tests, `vsce package`                            | [TEST_EVIDENCE.md](TEST_EVIDENCE.md)                                               | Release lead                                                           |
| Swift format/tests/Release build      | PASS           | SwiftFormat 0.61.1; 107 tests; warnings-as-errors                    | [TEST_EVIDENCE.md](TEST_EVIDENCE.md)                                               | Release lead                                                           |
