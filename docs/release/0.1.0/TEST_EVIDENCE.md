...
| Node quality              | `npm run lint`; `npm run format:check`; `npm test`                                                   | clean; 8/8 passing                                                             |
| VSIX                      | `npm run package`                                                                                    | `codebase-combiner-0.0.1.vsix`, 85 files, 193.62 KB                            |
...
| Swift tests               | `cd SwiftExplorerApp && swift test`                                                                  | 107 tests, 0 failures                                                          |
