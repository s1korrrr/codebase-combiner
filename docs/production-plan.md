...
| 2026-07-16 | Repository cleanup  | Consolidated current audit/release evidence, rejected pathological nested globstars, and excluded local worktrees from VSIX packaging. | 24 Node tests, 119 Swift tests, release contracts, and a 41-file 91.62 KB VSIX passed.               | Apple notarization/publication remains external. |
