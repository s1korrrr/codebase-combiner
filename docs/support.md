...
For security vulnerabilities, follow the private-reporting instructions in the repository's [Security Policy](../SECURITY.md) instead of posting sensitive details publicly.

## Privacy

Read the app-specific [Privacy Policy](privacy-policy.md). Codebase Combiner works locally and does not transmit source files, prompts, or usage data to the developer.
